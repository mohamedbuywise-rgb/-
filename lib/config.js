...
// GROQ_CLASSIFY_MODEL: خاص بخطوة تصنيف المصروف/الدين بس (classifyMessage) — دي الخطوة اللي محتاجة
// أعلى دقة ممكنة عشان تقسّم الرسالة الطويلة صح، فبتاخد الموديل الأكبر (gpt-oss-120b).
// آخر تأكيد إنه شغال ومفيش deprecation: 29 أغسطس 2026.
export const GROQ_CLASSIFY_MODEL = process.env.GROQ_CLASSIFY_MODEL || 'openai/gpt-oss-120b';
// GROQ_TEXT_MODEL: باقي الميزات النصية الأبسط (شات "اسأل دبّر"، ملخص Wrapped، ملاحظة التقرير،
// رسالة التذكير) — دي مش محتاجة نفس دقة التصنيف، فبتفضل على الموديل الأرخص (gpt-oss-20b)
// عشان الفرق في التكلفة يترّكز بس في الخطوة اللي فعلاً محتاجة الذكاء الإضافي.
...
export const USAGE_LIMITS = {
  paid: { voice: 250, ocr: 50, chat: 180, text: 300 },
  trial: { voice: 60, ocr: 30, chat: 50, text: 80 },
};

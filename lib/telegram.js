...
// ============ الرد على ضغطة زرار inline (callback_query) — لازم يتبعت دايمًا حتى لو من غير نص ============
// من غير الرد ده، تليجرام بيسيب الزرار في حالة "تحميل" (⏳) في واجهة المستخدم لحد ما ينتهي
// timeout بتاعه. النص هنا (لو موجود) بيظهر كـ toast صغير فوق، مش كرسالة في الشات.

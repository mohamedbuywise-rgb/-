...
- قاعدة حاسمة لـ "debt" — لازم اسم علم حقيقي، مش نوع "دليفري/تاكسي" عادي:
  * "person" في نوع "debt" لازم يكون اسم شخص أو شركة حقيقي مذكور صراحة في الرسالة (زي "أحمد"، "العمده صلاح"، "شركة النور"). الكلمات العامة زي "حد"، "واحد"، "زول"، "شخص"، "اللي طلب" **مش أسماء ولا تعتبر شخص محدد أبدًا**.
  * لو مفيش اسم علم حقيقي واضح في الرسالة، **ممنوع تستخدم نوع "debt" خالص** ولا تحط "غير محدد" كـ person أبدًا — بدل كده صنّفها "expense" عادي لو الفلوس خرجت من المستخدم، أو "income" لو دخلتله، حسب السياق العام للجملة.
  * كلمات "دليفري"، "توصيل"، "تاكسي"، "أوبر"، "مشوار"، "أوتوبيس"، "ميكروباص" دايمًا "expense" بفئة "مواصلات" (أو فئة توصيل مناسبة)، **حتى لو الجملة فيها كلمة "مني" أو "حد" أو صيغة شبيهة بصيغ الدين** — لأنها مصاريف تنقّل/توصيل عادية مش دين، إلا لو اتقال معاها اسم علم حقيقي صريح بيطلب يرجعله الفلوس (وقتها بس تبقى "debt" بنفس الاسم الحقيقي المذكور).
...
"دليفري حد مني 80 جنيه" -> {"transactions": [{"type":"expense","amount":80,"category":"مواصلات","note":"دليفري"}]}
"تاكسي حد مني 60 جنيه" -> {"transactions": [{"type":"expense","amount":60,"category":"مواصلات","note":"تاكسي"}]}

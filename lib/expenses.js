...
// ============ صافي الثروة: كل الدخل من أول ما المستخدم بدأ يستخدم دبّر ناقص كل المصروف، زائد صافي الديون ============
// ده تقدير مبسّط (مفيش تتبع رصيد بنكي فعلي)، فبيعتمد بالكامل على العمليات المسجّلة في دبّر.
